...
pub struct Intrinsics<'ctx> {
    ...
    pub fp_oeq_md: BasicMetadataValueEnum<'ctx>,
    pub fp_ogt_md: BasicMetadataValueEnum<'ctx>,
    pub fp_oge_md: BasicMetadataValueEnum<'ctx>,
    pub fp_olt_md: BasicMetadataValueEnum<'ctx>,
    pub fp_ole_md: BasicMetadataValueEnum<'ctx>,
    pub fp_one_md: BasicMetadataValueEnum<'ctx>,
    pub fp_ord_md: BasicMetadataValueEnum<'ctx>,
    pub fp_ueq_md: BasicMetadataValueEnum<'ctx>,
    pub fp_ugt_md: BasicMetadataValueEnum<'ctx>,
    pub fp_ult_md: BasicMetadataValueEnum<'ctx>,
    pub fp_ule_md: BasicMetadataValueEnum<'ctx>,
    pub fp_une_md: BasicMetadataValueEnum<'ctx>,
...
impl<'ctx> Intrinsics<'ctx> {
    ...
    pub fn declare(module: &Module<'ctx>, context: &'ctx Context) -> Self {
        ...
        let intrinsics = Self {
            ...
            fp_rounding_md: fp_rounding_md.into(),
            fp_exception_md: fp_exception_md.into(),

            fp_oeq_md: fp_oeq_md.into(),
            fp_ogt_md: fp_ogt_md.into(),
            fp_oge_md: fp_oge_md.into(),
            fp_olt_md: fp_olt_md.into(),
            fp_ole_md: fp_ole_md.into(),
            fp_one_md: fp_one_md.into(),
            fp_ord_md: fp_ord_md.into(),
            fp_ueq_md: fp_ueq_md.into(),
            fp_ugt_md: fp_ugt_md.into(),
            fp_ult_md: fp_ult_md.into(),
            fp_ule_md: fp_ule_md.into(),
            fp_une_md: fp_une_md.into(),
            fp_uno_md: fp_uno_md.into(),
